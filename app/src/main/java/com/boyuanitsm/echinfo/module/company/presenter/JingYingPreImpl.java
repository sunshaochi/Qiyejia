...
public class JingYingPreImpl extends BasePresenterImpl<IJingyingView> implements IJingYingPre {
    ...
    @Override
    public void getQiYeinfo(String companyName, String address, String industry, String capital, String establishDate, int page, int rows) {
        model.getfindStockMsgInfo(companyName, address, industry, capital, establishDate, page, rows, new ResultCallback<ResultBean<DateBean<CompanyBean>>>() {
            @Override
    ...
    public void getQiYeinfobyPinPai(String webAddress, String address, String industry, String capital, String establishDate, int page, int rows) {
        model.findEnterpriseInfoByProductName(webAddress, address, industry, capital, establishDate, page, rows, new ResultCallback<ResultBean<DateBean<CompanyBean>>>() {
            @Override
            public void onError(int status, String errorMsg) {
                mView.findEnterpriseInfoByNameFaild(status, errorMsg);
